...
public class InitEnv : MonoBehaviour
{
    ...
    private void Awake() {
        ...
        RightPlayArea = transform.Find("RightPlayArea").gameObject;
    ...
    */
    ...
    private void initWalls(Vector3[] areaVertices)
    {
        ...
        GameObject WallsParent = transform.Find("RightPlayArea/Walls").gameObject;
        for(int i = 0; i < 4; i++)
        {
